...
const initializeSystemActivation = async () => {
  try {
    const SystemActivation = (await import('../models/SystemActivation.js')).default;
...
export const initializeDefaultPengaturan = async () => {
  try {
    const PengaturanAbsen = (await import('../models/PengaturanAbsen.js')).default;
    const PengaturanSKS = (await import('../models/PengaturanSKS.js')).default;
    const PengaturanIstirahat = (await import('../models/PengaturanIstirahat.js')).default;
...
export const initializeDefaultPengaturanNilai = async () => {
  try {
    const PengaturanKomponenNilai = (await import('../models/PengaturanKomponenNilai.js')).default;
    const PengaturanGrade = (await import('../models/PengaturanGrade.js')).default;
    const PengaturanNilaiMinimal = (await import('../models/PengaturanNilaiMinimal.js')).default;
...
export const initializeDefaultWaliKelasSettings = async () => {
  try {
    const WaliKelasSettings = (await import('../models/WaliKelasSettings.js')).default;
